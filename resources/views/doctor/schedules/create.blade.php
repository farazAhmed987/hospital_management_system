...
@section('page-title', 'Add New Schedule')
            ...
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('day_of_week') is-invalid @enderror" id="day_of_week" name="day_of_week" required>
                            ...
                            @foreach($daysOfWeek as $key => $value)
                                <option value="{{ $key }}" {{ old('day_of_week') === $key ? 'selected' : '' }}>{{ $value }}</option>
                            @endforeach
                        </select>
                        @error('day_of_week')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('max_patients_per_slot') is-invalid @enderror" 
                                   id="max_patients_per_slot" name="max_patients_per_slot" value="{{ old('max_patients_per_slot', 1) }}" min="1" max="10" required>
                ...
                <div class="col-md-6">
                    <div class="alert alert-info">
                        <h6><i class="bi bi-info-circle me-2"></i>Schedule Information</h6>
                        <ul class="mb-0">
                            <li>Set your availability for patient appointments</li>
                            <li>Slot duration determines appointment length</li>
                            <li>You can have multiple schedules per day at different times</li>
                            <li>Overlapping schedules are not allowed</li>
                        </ul>
                    </div>
                </div>
            </div>
